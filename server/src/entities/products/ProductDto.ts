...
export class ProductDto {
  ...
  @ApiProperty({
    example: 'Detailed description of the gaming mouse',
  ...
  @ApiProperty({
    example: false,
    description: 'Находится ли продукт в процессе покупки',
  })
  @IsBoolean()
  inProcess: boolean;
  ...
  @ApiProperty({
    example: 'c9b1a16e-5f2f-46b3-b8e4-79f4162b2c56',
    description: 'ID владельца продукта',
  })
  @IsUUID()
  ownerId: string;
  ...
  @ApiProperty({
    example: 'c9b1a16e-5f2f-46b3-b8e4-79f4162b2c56',
    description: 'ID покупателя продукта',
  })
  @IsUUID()
  buyerId: string;
