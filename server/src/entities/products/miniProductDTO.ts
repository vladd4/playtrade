...
export class ProductMiniDto {
    ...
    @ApiProperty({ example: 'http://example.com/image.jpg', description: 'URL изображения продукта' })
    @IsString()
    imageUrl: string;
    ...
    @ApiProperty({ example: 'A high-end gaming mouse', description: 'Краткое описание продукта' })
    @IsString()
    description: string;
