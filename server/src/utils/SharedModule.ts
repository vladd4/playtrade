...
import {MessageEntity} from "../entities/messages/message.entity"; // Импортируйте WebSocketBotModule
...
@Module({
    imports: [
        ...
        UsersModule,
        JwtModule,
        forwardRef(() => WebSocketBotModule), // Используйте forwardRef для WebSocketBotModule
        MessagesModule,
